...
# In this .hcl, the iaddl instruction is implemented.

# In the descriptions below, stage names are abbreviated.
# F - Fetch	D - Decode	E - Execute
# M - Memory	W - Write back	P - PC update

# The description of the iaddl instruction:
# Stage	iaddl V, rB
# F	icode:ifun <- M1[PC]
# 	rA:rB <- M1[PC + 1]
#	valC <- M4[PC + 2]
